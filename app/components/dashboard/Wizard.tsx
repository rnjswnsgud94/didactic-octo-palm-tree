                ...
                <label>
                  ...
                  <select
                    ...
                    onChange={(event) => {
                      ...
                      if (province === "충청북도") onChange("city", "청주시");
                      else if (province === "충청남도") onChange("city", "천안시");
                      else if (province === "대전광역시") onChange("city", "유성구");
                      else onChange("city", "미확인");
                    }}
                  >
                    <option>충청북도</option>
                    <option>충청남도</option>
        ...
        {activeStep === 2 ? (
          <>
            ...
            <div className="inline-notice warning">
              <strong>환경·화학 범위</strong>
              <span>환경영향평가, 화관법 영업허가, 위험물·고압가스는 현재 자동판정 범위 밖입니다.</span>
            </div>
          </>
        ) : null}
