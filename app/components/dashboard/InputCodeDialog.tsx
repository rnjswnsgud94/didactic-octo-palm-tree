      ...
      <div className="status-dialog-panel input-code-panel">
        <header>
          <div>
            ...
            <p id="input-code-dialog-description">현재 입력값을 문자열로 보관하거나, 다른 기기에서 만든 코드를 붙여 넣어 그대로 복원할 수 있습니다.</p>
          </div>
        ...
        <div className="input-code-body">
          ...
          <div className="input-code-meta">
            <p id="input-code-help" className="input-code-help">코드에는 사업지역·규모·시설 조건 등 현재 입력내용이 포함됩니다. 외부 공유 전 내용을 취급할 대상을 확인해 주세요.</p>
