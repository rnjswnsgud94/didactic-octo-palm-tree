...
- 전국 공통: 산업단지 입주계약, 개별입지 공장설립 승인, 건축허가·착공신고·사용승인, 공장설립 완료신고의 기본 경로
- 우선 지역: 충북 청주시·충남 천안시(현재는 전국 공통층만 적용)
- 업종 시나리오: 일반 제조업, 반도체·전자, 이차전지·화학공정
- 사용자 확인값 기반 조건부 표시: 대기·수질 배출시설, 공정안전보고서(PSM), 전력·용수·폐수 사전협의
- 판정 상태: `적용`, `비적용`, `적용 가능성`, `추가정보 필요`

지역 자치법규, 개별 산업단지 관리기본계획, 환경영향평가, 화학물질관리법 세부 임계값, 위험물·고압가스·소방·전기 검사, 입지규제는 자동판정하지 않습니다. 전체 목록은 [coverage-and-gaps.md](docs/coverage-and-gaps.md)에 있습니다.
...
- 카탈로그 버전: `2026.08.20-mvp.1`
- 마지막 법령 공개페이지 검토: `2026-08-20`
- 다음 재검토 기준일: `2026-09-11`
- 대기·수질 시행본, 청주·천안 자치법규, 개별 산단 계획과 공급기관 기준은 사람 검토가 남아 있습니다.
