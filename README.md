...
- 절차 카탈로그: 입지·건축, 환경, 화학, 산업안전, 소방, 전기, 가스, 에너지까지 전국 공통 법령층 50개 절차
- 지원 지역: 서울·경기·인천을 제외한 전국 비수도권 14개 시·도(시·군·구 직접 입력)
...
지역 자치법규, 개별 산업단지 관리기본계획, 시설·물질·수량별 세부 임계값과 필지별 입지규제는 자동 확정하지 않습니다. 전체 목록은 [coverage-and-gaps.md](docs/coverage-and-gaps.md)에 있습니다.
...
GitHub Pages에서는 대시보드 판정, 입력값 복원, 공유 링크와 공식 법령 원문 링크를 사용할 수 있습니다. 서버 API를 실행할 수 없는 정적 호스팅이므로 `API 최신성 확인`은 운영 사이트에서 제공합니다.
...
- 카탈로그 버전: `2026.08.20-noncapital.3`
- 마지막 법령 공개페이지 검토: `2026-08-20`
- 다음 재검토 기준일: `2026-09-11`
- 대기·수질 시행본, 비수도권 시·군·구별 자치법규, 개별 산단 계획과 공급기관 기준은 사람 검토가 남아 있습니다.
